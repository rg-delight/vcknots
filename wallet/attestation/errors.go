...
var (
	...
	// malformed, unauthenticated, carries a cnf.jwk that is not a public
	// asymmetric key, or is not bound to this client_id, client key,
	...
	// malformed, unauthenticated, lists an attested key that is not a public
	// asymmetric key, or does not cover the holder keys, c_nonce, audience or
	// a future exp of the Credential Request.
