...
func codedErrorValues() map[string]error {
	return map[string]error{
		...
		"acceptance.ErrIssuerX5CRequired":                    acceptance.ErrIssuerX5CRequired,
		"acceptance.ErrIssuerX5CTrustAnchor":                 acceptance.ErrIssuerX5CTrustAnchor,
		...
		"oid4vp.ErrRequestURIRequired":            oid4vp.ErrRequestURIRequired,
